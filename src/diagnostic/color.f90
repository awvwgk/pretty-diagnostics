...
!> Support for colorful terminal output
module diagnostic_color
  implicit none
  private
  ...
  interface color_type
    module procedure :: new_color
  end interface color_type

contains

  !> Create a new colorizer object
  function new_color(use_color) result(new)
    !> Enable color output
